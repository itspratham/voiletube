"""
ViewTube - YouTube-like Platform
Django Settings
"""
import os
...
ASGI_APPLICATION = 'viewtube.asgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='viewtube'),
...
AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME', default='viewtube-media')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ViewTube API',
    'DESCRIPTION': 'YouTube-like Video Platform API',
    'VERSION': '1.0.0',
}
